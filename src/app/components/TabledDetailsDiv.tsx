...
const TabledDetailsDiv = ({title,subText,descriptionData,supportImages    ,subTextUrl,subTextUrlText }:any) => {
  return (
      <div className="animate-view-in flex flex-col w-full   px-2    ">
<div className="relative grid grid-cols-12 my-10 gap-4">
...
export default TabledDetailsDiv